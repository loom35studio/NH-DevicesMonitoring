function getOids(printer) {
    let oids;
    if (printer.model == "OKI") {
        oids = [ "1.3.6.1.2.1.43.11.1.1.9.1.1",    // [0][1]   Bk
                 "1.3.6.1.2.1.43.11.1.1.9.1.2",    // [2][3]   Cy
                 "1.3.6.1.2.1.43.11.1.1.9.1.3",    // [4][5]   Ma
                 "1.3.6.1.2.1.43.11.1.1.9.1.4",    // [6][7]   Ye
                ]
    }
